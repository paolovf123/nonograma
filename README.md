...
Duelo de nonogramas para proyectar en clase. Dos jugadores resuelven 3 nonogramas cada uno, por turnos alternados, con cronómetro al milisegundo. Gana quien sume menos tiempo.
...
1. **Configuración:** nombres de los jugadores, tamaño de cada uno de los 3 puzzles (5×5 a 10×10), límite de tiempo por puzzle (0 = sin límite) y si se tachan las filas y columnas ya completas.
2. **Puzzles:** se generan al azar con solución única. Cada jugador recibe puzzles distintos, pero del mismo tamaño en cada ronda.
3. **Turnos:** puzzle 1 del jugador 1, puzzle 1 del jugador 2, luego el 2 de cada uno y el 3 de cada uno.
...
6. **Resultado:** suma de los 3 tiempos de cada jugador, al milisegundo, con el desglose por puzzle.
...
|---|---|
| `index.html` | El juego completo (HTML, CSS y JS, sin dependencias). Incluye el generador y el solucionador que garantiza solución única. |
